...
public class AsmDemo extends ClassLoader implements Opcodes {
    ...
    public void test() throws IOException, InstantiationException, IllegalAccessException, InvocationTargetException {
        ...
        Class<?> exampleClass = defineClass(Foo.class.getName(), code, 0, code.length);

        System.out.println("method数量");
//        System.out.println("***************************");
        System.out.println("method数量");
        System.out.println("method数量：" + exampleClass.getMethods().length);
